...
- (NSMutableArray *)getSampleBugDocs
{
    NSMutableArray *sampleBugs = [[NSMutableArray alloc] init];
    ...
    [sampleBugs addObject:bug1];
    [sampleBugs addObject:bug2];
    [sampleBugs addObject:bug3];
    [sampleBugs addObject:bug4];
